  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        text-[14px] max-w[500px]'>Create imaginative and visually stunning images through by DALL-E AI share them with the community</p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-7'>
          ...
          <FormField
            ...
            type='text'
            name='prompt'
            placeholder='A Dinosaur exploring Cape Town'
            value={form.prompt}
            handleChange={handleChange}
            isSupriseMe
          ...
          focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
            ...
            {generatingImg && (
              ...
              justify-center items-center bg-[rgba(0,0,0,0.5)] rounded-true'>
                <Loader />
              </div>
            )
            }
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once
            you have created the image you want, you can share
